cc.Class({
    ...
    onQuickChatItemClicked:function(event){
        ...
        cc.vv.net.send("connector.gameHandler.quick_chat",info.index);
    },
    
    onEmojiItemClicked:function(event){
        console.log(event.target.name);
        this._chatRoot.active = false;
        cc.vv.net.send("connector.gameHandler.emoji",event.target.name);
    },
    ...
    onBtnSendChatClicked:function(){
        ...
        cc.vv.net.send("connector.gameHandler.chat",this._iptChat.string);
