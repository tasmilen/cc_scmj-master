cc.Class({
    ...
    shoot:function(mjId){
        ...
        cc.vv.net.send('connector.gameHandler.chupai',mjId);
    },
    ...
    onOptionClicked:function(event){
        ...
        if(event.target.name == "btnPeng"){
            cc.vv.net.send("connector.gameHandler.peng");
        }
        else if(event.target.name == "btnGang"){
            cc.vv.net.send("connector.gameHandler.gang",event.target.pai);
        }
        else if(event.target.name == "btnHu"){
            cc.vv.net.send("connector.gameHandler.hu");
        }
        else if(event.target.name == "btnGuo"){
            cc.vv.net.send("connector.gameHandler.guo");
        }
    },
