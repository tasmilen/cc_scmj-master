cc.Class({
    ...
    onBtnClicked:function(event){
        ...
        if(btnName == "btn_agree"){
            cc.vv.net.send("connector.gameHandler.dissolve_agree");
        }
        else if(btnName == "btn_reject"){
            cc.vv.net.send("connector.gameHandler.dissolve_reject");
        }
        else if(btnName == "btn_sqjsfj"){
            cc.vv.net.send("connector.gameHandler.dissolve_request");
        }
    },
