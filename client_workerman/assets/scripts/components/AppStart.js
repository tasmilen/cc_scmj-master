...
function initMgr(){
    ...
    cc.vv.ws = require("Websocket");
    cc.vv.ws.connect(function (data) {
        cc.log('连接成功了吗')
        cc.log(data)
    });
...
cc.Class({
    ...
    getServerInfo:function(){
        ...
        var fnRequest = function(){
            ...
            cc.vv.ws.send('get_serverinfo', null);
            xhr = 1;
            setTimeout(fn,5000);            
        }
        var fn = function(){
        ...
        cc.vv.ws.on('get_serverinfo', function(data) {
            cc.log('我收到回调了')
            complete = true;
            xhr = null;
            onGetVersion(data.message);
        });
        fn();
    },
