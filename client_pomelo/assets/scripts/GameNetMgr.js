cc.Class({
    ...
    initHandlers:function(){
        ...
        pomelo.on("exit_result",function(data){
            self.roomId = null;
            self.turn = -1;
            self.dingque = -1;
        ...
        pomelo.on("exit_notify_push",function(data){
           var userId = data;
        ...
        pomelo.on("dispress_push",function(data){
            self.roomId = null;
            self.turn = -1;
            self.dingque = -1;
            self.isDingQueing = false;
        ...
        pomelo.on('new_user_comes_push', (data) => {
        ...
        pomelo.on("user_state_push",function(data){
        ...
        pomelo.on("user_ready_push",function(data){
        ...
        pomelo.on("game_holds_push",function(data){
        ...
        pomelo.on("game_begin_push",function(data){
        ...
        pomelo.on("game_playing_push",function(data){
        ...
        pomelo.on("game_sync_push",function(data){
        ...
        pomelo.on("game_dingque_push",function(data){
        ...
        pomelo.on("game_huanpai_push",function(data){
        ...
        pomelo.on("hangang_notify_push",function(data){
          console.log('hangang_notify_push');
          console.log(data);
          self.dispatchEvent('hangang_notify',data);
        });
        
        pomelo.on("game_action_push",function(data){
          console.log('game_action_push');
          console.log(data);
            self.curaction = data;
        ...
        pomelo.on("game_chupai_push",function(data){
        ...
        pomelo.on("game_num_push",function(data){
        ...
        pomelo.on("game_over_push",function(data){
        ...
        pomelo.on("mj_count_push",function(data){
        ...
        pomelo.on("hu_push",function(data){
            console.log('hu_push');
            console.log(data);
            self.doHu(data);
        });
        
        pomelo.on("game_chupai_notify_push",function(data){
        ...
        pomelo.on("game_mopai_push",function(data){
            console.log('game_mopai_push');
          console.log(data);
            self.doMopai(self.seatIndex,data);
        });
        
        pomelo.on("guo_notify_push",function(data){
        ...
        pomelo.on("game_huanpai_over_push",function(data){
        ...
        pomelo.on('peng_notify_push', (data) => {
        ...
        pomelo.on('gang_notify_push', (data) => {
        ...
        pomelo.on('chat_push', (data) => {
            console.log(data);
            self.dispatchEvent("chat_push",data);
        });
        
        pomelo.on('quick_chat_push', (data) => {
            console.log(data);
            self.dispatchEvent("quick_chat_push",data);
        });

        pomelo.on('emoji_push', (data) => {
            console.log(data);
            self.dispatchEvent("emoji_push",data);
        });
        
        pomelo.on('dissolve_notice_push', (data) => {
        ...
        pomelo.on("dissolve_cancel_push",function(data){
            self.dissoveData = null;
            self.dispatchEvent("dissolve_cancel",data);
        });
        
        pomelo.on("voice_msg_push",function(data){
    ...
    connectGameServer:function(data){
        ...
        var onConnectOK = function(){
            ...
            cc.vv.net.send("connector.gameHandler.login", sd);
        };
        ...
        cc.log('拼命进入游戏中 ' + data.roomid)
        pomelo.notify('connector.gameHandler.login', {
            roomid: data.roomid,
        })
    }
